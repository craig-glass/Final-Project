...
namespace DefaultNamespace
{
    ...
    public class Turtle
    {
        ...
        public void Translate(Vector3 delta)
        {
            ...
            //UnityEngine.Debug.DrawLine(Position, Position + delta, Color.black, 100f);
            Position += delta;
        }
